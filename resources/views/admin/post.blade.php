      ...
      <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <tbody>
                ...
                <tr class="border hover:bg-gray-50">
                  ...
                  <td class="py-2 px-4 border"><span
                      class="px-2 py-1 bg-green-200 text-green-800 rounded text-xs">Published</span></td>
          ...
          <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
            ...
            <form method="post" action="{{ route("adminInsertPost.page") }}" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="file" name="img"
                  class="w-full px-3 py-2 border rounded bg-white focus:outline-none focus:ring-2 focus:ring-red-400">
              </div>
              <div class="mb-3">
                <label class="block text-sm mb-1 text-gray-600">Content</label>
                <textarea rows="4" placeholder="Enter news content..." name="content"
                  class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-400"></textarea>
              </div>
              <div class="mb-4">
                <label class="block text-sm mb-1 text-gray-600">Status</label>
                <select name="status" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-400">
