    ...
    <div class="bg-white p-4 rounded-lg flex shadow hover:shadow-md transition">
      ...
      <div class="ml-4 flex flex-col justify-between">
        <div>
          ...
          <p class="text-sm text-gray-600 mt-1">A political stir is in the making as sources suggest a major cabinet
            reshuffle...</p>
        </div>
    ...
    <div class="bg-white p-4 rounded-lg flex shadow hover:shadow-md transition">
      ...
      <div class="ml-4 flex flex-col justify-between">
        <div>
          ...
          <p class="text-sm text-gray-600 mt-1">Researchers in India launch a new AI model to detect diseases in
            seconds...</p>
        </div>
    ...
    <div class="bg-white p-4 rounded-lg flex shadow hover:shadow-md transition">
      ...
      <div class="ml-4 flex flex-col justify-between">
        <div>
          ...
          <p class="text-sm text-gray-600 mt-1">With an explosive performance, India secured the series 3-1 at home...
          </p>
        </div>
